package net.wooga.displaytreebuilder.grammar.datadefinition {
	...
	public interface CollectionProperty__DataDef$BlockContent$BlockStart extends CollectionProperty__DataDef, BlockContent, BlockStart, InstanceModification__DataDef {
	}
}
