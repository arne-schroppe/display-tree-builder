package net.wooga.displaytreebuilder.tools {
	...
	public class InstantiationTool {


		public static function instantiate(type:Class,  args:Array = null):Object {
			...
			switch(args.length) {
				...
				default: throw new ArgumentError("We cannot handle this many constructor arguments");
